...
const TOPI_DATA = [
  {
    ...
    makna: "Melambangkan kepemimpinan. Jumlah Terga (bulu Enggang) mencerminkan status sosial: Panyen (rakyat biasa) 3–4 helai; Paren (bangsawan) 5–8 helai.",
    kategori: "Bluko",
    warna: "#2C4A8C"
  },
  {
    ...
    pengguna: "Laki-laki dan perempuan (varian perempuan dengan pola daun di belakang khusus perempuan)",
  ...
  },
  {
    ...
    pengguna: "Perempuan",
    fungsi: "Digunakan dalam menari dan acara adat",
    makna: "Melambangkan kepemimpinan",
    kategori: "Bluko",
    warna: "#8C2C5E"
  },
  {
    ...
    makna: "Macan melambangkan kelemahlembutan, kesetiaan, kesabaran, dan keperkasaan.",
    kategori: "Tapung",
    warna: "#8B5E3C"
  },
  {
    ...
    pengguna: "Laki-laki",
    fungsi: "Dikenakan saat acara adat dan menari",
    makna: "Keseimbangan hidup dan persatuan tidak terlalu longgar, tidak terlalu kaku.",
    kategori: "Tapung",
    warna: "#7B5EA7"
  },
  {
    ...
    makna: "Melambangkan kesederhanaan.",
    kategori: "Tapung",
    warna: "#6B8C42"
  },
  {
    ...
    makna: "Melambangkan ketidaksempurnaan yang indah namun belum sempurna. Pemakai masih membutuhkan bimbingan dalam perjalanan hidup.",
    kategori: "Tapung",
    warna: "#A0784A"
  },
  {
    ...
    makna: "Melambangkan kesabaran dan keindahan.",
    kategori: "Tapung",
    warna: "#C0874F"   
  }
];
